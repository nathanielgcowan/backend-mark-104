...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { album: @band.album, chord: @band.chord, genre: @band.genre, instrument: @band.instrument, likes: @band.likes, name: @band.name } }, as: :json
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { album: @band.album, chord: @band.chord, genre: @band.genre, instrument: @band.instrument, likes: @band.likes, name: @band.name } }, as: :json
    assert_response 200
  end
